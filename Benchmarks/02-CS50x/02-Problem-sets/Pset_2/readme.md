...
3. But this isnt how we are supposed to solve it, we are to take the 2nd last and skip the next and then to the next and then multiply these with 2 and then sum them up. how? look below
