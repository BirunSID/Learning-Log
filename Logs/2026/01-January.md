...
- **Call of dragons** : Steady power up , speeding to T3 units fast.
---
---
...
- **Call of dragons** : Got a control hero, the more hero's the better , quick powerup boost hack.
---
---

## January 29th, Thursday:
- **Exercise**        : Squats(20/20) || Pushups(20/20) || Situps(20/20) || light sprint static(10s/10s)
- **IELTS**           : scored 8.0 , Band 0.5+ improvement.
- **German**          : 
- **CS50x**           : yeah, did half of the triangle of the Pset 1, now other half on saturday. see more details [here](../../Benchmarks/00-ARCHIVED_&_DELETED/01-January-2026.md) (scroll down if needed be.).
- **Book Reading**    : Deep work 10P(61-70) done || Psychology of money 10p(81-90) done.
- **Factorio**        : 
- **Call of dragons** : did some power ups.