...
def main():
    ...
    # TODO: Find longest match of each STR in DNA sequence
        # Extract everything except for the name keys
    strs = list(database_csv[0].keys())[1:]
    
        # dictionary to save the longest run of each str in the dna sequence
    dna_fingerprint = {}
    
        # for each str, find the longest run and save it
    for s in strs:
