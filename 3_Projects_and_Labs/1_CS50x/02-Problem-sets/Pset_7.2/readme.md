...
>[!warning] Changes for 2026: 5.sql now requires matching movies that begin with “Harry Potter and the “ (not just “Harry Potter”). 9.sql now requires outputting two columns (the ID and name of each person), not just names. If you started this problem prior to 2026, be sure to update your queries accordingly!
...
In 9.sql, write a SQL query to list the ID and names of all people who starred in a movie released in 2004, ordered by birth year.
...
NONE, its just the same as 7.1. Making queries.
