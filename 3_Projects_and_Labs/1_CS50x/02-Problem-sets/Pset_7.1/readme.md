...
There are no walkthrough. its just how it is. I Tested the queries in powershell and then I copypasted the ones that gave me the answer and I verified it and then put in the appropriate files.